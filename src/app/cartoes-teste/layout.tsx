...
// Layout isolado da Fase 3 (upload bruto de arquivo de cartão/EDI de conciliação).
// Propositalmente FORA do route group (app): não herda a sidebar/menu do sistema
// principal, não é linkado de nenhuma tela existente e só é alcançável digitando a URL.
export default function CartoesTesteLayout({ children }: { children: React.ReactNode }) {
