...
// Layout isolado da Fase 1 (extrato bancário OFX). Propositalmente FORA do
// route group (app): não herda a sidebar/menu do sistema principal, não é
// linkado de nenhuma tela existente e só é alcançável digitando a URL.
export default function ExtratoLayout({ children }: { children: React.ReactNode }) {
