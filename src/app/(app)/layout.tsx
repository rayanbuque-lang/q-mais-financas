...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-40 w-[260px] bg-[var(--color-surface)] border-r border-[var(--color-border)] flex flex-col transition-transform duration-300 ease-in-out ${
      ...
      <main className="flex-1 min-w-0">
        <div className="md:hidden flex items-center justify-between p-4 border-b border-[var(--color-border)] bg-[var(--color-surface)] sticky top-0 z-20">
          <Logo />
          <button
